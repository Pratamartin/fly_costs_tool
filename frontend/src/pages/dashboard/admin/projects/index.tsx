...
export default function DashboardAdminProjects() {
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <aside className="flex w-56 shrink-0 flex-col justify-between bg-[#1e2d3d] py-6 px-4">
        <div>
          ...
          <nav className="space-y-1">
            <button className="flex w-full items-center gap-2.5 rounded-lg px-3 py-2.5 text-sm font-medium text-white/50 hover:bg-white/5 hover:text-white/80 transition">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
        ...
        <header className="border-b border-gray-200 bg-white">
          <div className="px-8 pt-4 pb-0">
            ...
            <div className="mb-3 flex items-center gap-1.5 text-xs text-gray-500">
              ...
              <span className="text-gray-700 font-medium">Laboratório de Robótica 2026</span>
            </div>
            ...
            <div className="flex items-center justify-between pb-4">
              <div className="flex items-center gap-3">
                <button
                  onClick={() => router.push("/dashboard/admin")}
                  className="flex items-center justify-center rounded-lg p-1.5 text-gray-500 hover:bg-gray-100 transition"
                >
                ...
                <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-white px-6 py-5 shadow-sm">
                  <div>
                    ...
                    <p className="mt-1 text-2xl font-bold text-gray-900">
                      $150.000<span className="text-base font-normal text-gray-400">,00</span>
                    </p>
                ...
                <div className="flex flex-col justify-between rounded-xl border border-gray-200 bg-white px-6 py-5 shadow-sm">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-2xl font-bold text-gray-900">
                        $45.250<span className="text-base font-normal text-gray-400">,50</span>
                      </p>
                    </div>
                    <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-purple-50">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5 text-purple-600">
                ...
                <div className="mt-3 flex items-center justify-center gap-6">
                  {CHART_SERIES.map((series) => (
                    <div key={series.key} className="flex items-center gap-2">
                      <div className="h-3 w-3 shrink-0 rounded-sm" style={{ backgroundColor: series.color }} />
              ...
              <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
                      ...
                      <tr key={entry.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-700">{entry.submittedBy}</span>
                          </div>
                        </td>
                ...
                <div className="border-t border-gray-100 px-6 py-4">
                  <p className="text-sm text-gray-400">
                    Exibindo {RECENT_ACTIVITY.length} de 12 despesas
                  </p>
                </div>
              </div>
            </>
          ...
          {abaAtiva === "expenses" && (
            <div className="flex h-64 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-sm">
              <div className="text-center">
                ...
                <p className="text-sm font-medium text-gray-600">Lista de despesas em breve</p>
                <p className="mt-1 text-xs text-gray-400">Esta seção será implementada na próxima etapa</p>
              </div>
            </div>
          )}
            ...
            <div className="flex h-64 items-center justify-center rounded-xl border border-gray-200 bg-white shadow-sm">
              <div className="text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-indigo-50">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6 text-indigo-500">
                    <path d="M7 8a3 3 0 100-6 3 3 0 000 6zM14.5 9a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM1.615 16.428a1.224 1.224 0 01-.569-1.175 6.002 6.002 0 0111.908 0c.058.467-.172.92-.57 1.174A9.953 9.953 0 017 18a9.953 9.953 0 01-5.385-1.572zM14.5 16h-.106c.07-.297.088-.611.048-.933a7.47 7.47 0 00-1.588-3.755 4.502 4.502 0 015.874 2.636.818.818 0 01-.36.98A7.465 7.465 0 0114.5 16z" />
                  </svg>
                </div>
                <p className="text-sm font-medium text-gray-600">Membros da equipe em breve</p>
                <p className="mt-1 text-xs text-gray-400">Esta seção será implementada na próxima etapa</p>
              </div>
            </div>
          )}
