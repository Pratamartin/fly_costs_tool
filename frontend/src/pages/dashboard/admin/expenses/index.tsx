...
function StatusBadge({ status }: { status: ExpenseStatus }) {
  const config: Record<ExpenseStatus, { bg: string; ring: string; text: string; dot: string; label: string }> = {
    ...
    CONCLUIDO:        { bg: "bg-violet-50", ring: "ring-violet-200", text: "text-violet-700", dot: "bg-violet-500",  label: "Concluído" },
  };
...
export default function AdminExpenses() {
  ...
  const concluidoCount = expenses.filter((e) => e.status === "CONCLUIDO").length;
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-gray-50 dark:bg-gray-950">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">Carregando despesas...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="flex h-screen overflow-hidden bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex flex-col gap-3 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-8 sm:py-4">
          <div>
            <h1 className="text-base font-bold text-gray-900 dark:text-gray-50 sm:text-xl">Solicitações de Despesas</h1>
            <p className="text-xs text-gray-500 dark:text-gray-400 sm:text-sm">Gerencie e revise todas as solicitações de despesas dos projetos</p>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative flex-1 sm:flex-none">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 py-2 pl-9 pr-4 text-sm text-gray-800 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 outline-none focus:border-[#1e2d3d] focus:ring-1 focus:ring-[#1e2d3d] sm:w-56"
              />
            </div>
            <ThemeToggle />
            <button
        ...
        <main className="flex-1 overflow-y-auto px-4 py-4 md:px-8 md:py-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-4">
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm">
              ...
              <p className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-50">{totalCount}</p>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm">
              ...
              <p className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-50">{pendingCount}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Aguardando Revisão</p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm">
              ...
              <p className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-50">{approvedCount}</p>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm">
              ...
              <p className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-50">{rejectedCount}</p>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm">
              ...
              <p className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-50">{emEdicaoCount}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Em Edição</p>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-5 py-4 shadow-sm">
              <div className="flex items-start justify-between">
                ...
                <span className="text-xs font-semibold text-violet-500">Total</span>
              </div>
              <p className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-50">{concluidoCount}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Concluídas</p>
            </div>
          </div>

          {/* Filter & view toggle */}
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-6 py-4 shadow-sm">
            <div className="flex flex-wrap items-end gap-4">
              <div>
                ...
                <select
                  ...
                  className="rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 py-2 pl-3 pr-8 text-sm text-gray-700 dark:text-gray-100 outline-none focus:border-[#1e2d3d] focus:ring-1 focus:ring-[#1e2d3d]"
                >
              ...
              <div>
                <label className="mb-1.5 block text-xs font-medium text-gray-500 dark:text-gray-400">Ordenar por</label>
                <select
                  value={sortBy}
              ...
              <div className="flex items-end ml-auto">
                <div className="flex rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                  <button
                    ...
                    className={`p-2 transition ${viewMode === "table" ? "bg-[#2563EB] text-white" : "text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800"}`}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
                  ...
                  <button
                    ...
                    className={`p-2 transition ${viewMode === "grid" ? "bg-[#2563EB] text-white" : "text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800"}`}
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm">
            <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-6 py-4">
              <div>
                <h2 className="text-sm font-semibold text-gray-800 dark:text-gray-100">Solicitações de Despesas</h2>
                <p className="text-xs text-gray-400 dark:text-gray-500">Exibindo {filtered.length} despesas no total</p>
              </div>
            </div>
            ...
            {viewMode === "table" ? (
              <>
                <table className="hidden w-full md:table">
                  <thead>
                    <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800">
                      ...
                      <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">ID</th>
                      <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">Solicitação</th>
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    {paginated.length === 0 ? (
                      ...
                      <tr key={expense.id} className={`hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${selected.has(expense.id) ? "bg-blue-50/40" : ""}`}>
                        ...
                        <td className="px-4 py-3">
                          {expense.student ? (
                            <div className="flex items-center gap-2">
                              ...
                              <p className="text-sm font-medium text-gray-800 dark:text-gray-100">{expense.student.name}</p>
                            </div>
                          ) : (
                        ...
                        <td className="px-4 py-3">
                          <p className="text-sm text-gray-700 dark:text-gray-300">{expense.event?.name}</p>
                          <p className="text-xs text-gray-400 dark:text-gray-500">{expense.event?.location}</p>
                        </td>
                ...
                <div className="flex items-center justify-between border-t border-gray-100 dark:border-gray-800 px-6 py-4">
                  ...
                  <div className="flex items-center gap-2">
                    <button disabled={currentPage === 1} onClick={() => setCurrentPage((p) => p - 1)} className="rounded-lg border border-gray-200 dark:border-gray-700 p-1.5 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition">
                    ...
                    <span className="rounded-lg border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300">{currentPage} / {totalPages || 1}</span>
                    <button disabled={currentPage >= totalPages} onClick={() => setCurrentPage((p) => p + 1)} className="rounded-lg border border-gray-200 dark:border-gray-700 p-1.5 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-40 disabled:cursor-not-allowed transition">
                ...
                <div className="md:hidden divide-y divide-gray-100 dark:divide-gray-800">
                  {paginated.length === 0 ? (
                    <p className="py-12 text-center text-sm text-gray-400 dark:text-gray-500">Nenhuma despesa encontrada.</p>
                  ) : paginated.map((expense) => (
                    <div key={expense.id} className={`px-4 py-4 hover:bg-gray-50 dark:hover:bg-gray-800 ${selected.has(expense.id) ? "bg-blue-50/40" : ""}`}>
                      ...
                      <p className="text-sm font-medium text-gray-800 dark:text-gray-100 mb-0.5">{expense.title}</p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 mb-2">{expense.project?.name ?? "Sem projeto"} · {expense.event?.location}</p>
                      <div className="flex items-center justify-between">
                        {expense.student && (
                          <div className="flex items-center gap-2">
                            <Avatar name={expense.student.name} />
                            <p className="text-xs font-medium text-gray-700 dark:text-gray-300">{expense.student.name}</p>
                          </div>
                        )}
              ...
              <div className="p-6">
                {paginated.length === 0 ? (
                  <p className="py-16 text-center text-sm text-gray-400 dark:text-gray-500">Nenhuma despesa encontrada.</p>
                ) : (
                  <div className="grid grid-cols-2 gap-4 xl:grid-cols-3">
                    {paginated.map((expense) => (
                      <div key={expense.id} className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p className="text-sm font-semibold text-gray-900 dark:text-gray-50 mb-0.5">{expense.title}</p>
                        <p className="text-xs text-gray-400 dark:text-gray-500 mb-3">{expense.event?.location}</p>
