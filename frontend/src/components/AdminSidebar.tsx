...
type NavId = "dashboard" | "projects" | "expenses" | "profile" | "settings";
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#1e2d3d] shadow-lg md:hidden"
      ...
      >
        ...
        <button
          onClick={() => setMobileOpen(false)}
          className="absolute right-3 top-3 rounded-lg p-1.5 text-white/40 hover:bg-white/10 hover:text-white md:hidden"
