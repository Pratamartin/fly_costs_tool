  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#4F46E5] shadow-lg shadow-[#4F46E5]/30 transition hover:bg-[#4338ca] dark:bg-[#818cf8] dark:shadow-black/30 dark:hover:bg-[#a5b4fc] md:hidden"
      ...
      >
            ...
            <button
              ...
              className={`flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold transition ${
                router.pathname === "/dashboard/student"
                  ? "bg-[#4F46E5]/10 text-[#4F46E5] dark:bg-[#818cf8]/15 dark:text-[#c7d2fe]"
        ...
        <div className="space-y-3 border-t border-gray-200 pt-4 dark:border-gray-800">
          <div className="flex items-center gap-3 rounded-lg px-2 py-2">
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#4F46E5] text-sm font-bold text-white dark:bg-[#818cf8] dark:text-gray-950">
              {userName?.charAt(0).toUpperCase() ?? "?"}
            </div>
            <div className="min-w-0">
              <p className="truncate text-sm font-semibold text-gray-800 dark:text-gray-100">{userName ?? "Carregando..."}</p>
              <p className="truncate text-xs text-gray-400 dark:text-gray-500">Aluno</p>
            </div>
          </div>
          <button
            onClick={onLogout}
